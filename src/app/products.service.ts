...
export class ProductService {
  getProductsData() {
    return [{
      ...
      description: 'Boost your online presence with our expert SEO consultancy',
      image: 'ICON SEO CONSULTING.png',
      price: 65,
    ...
    },
      {
        ...
        description: 'Content is the game-changer—it decides if your customer stays or leaves',
        image: 'ICON CONTENT MARKETING.png',
        price: 65,
        category: 'Accessories',
        quantity: 24,
        inventoryStatus: 'INSTOCK',
      ...
      },
      {
        ...
        description: 'Unlock the power of strategic keyword research to drive targeted traffic and amplify your digital reach',
        image: 'ICON KEYWORD RESEARCH.png',
        price: 65,
        category: 'Accessories',
        quantity: 24,
        inventoryStatus: 'INSTOCK',
